		...
		<tr>
			<td align="center">
				<table class="w640" border="0" cellpadding="0" cellspacing="0" width="640">
					...
					<tr>
						<td id="header" class="w640" align="center" width="640">
							<table class="w640" border="0" cellpadding="0" cellspacing="0" width="640">
								...
								<tr>
									<td colspan="3" height="20" class="large_only">
                                    <img src="{{ asset(\App\Setting::get('appLogoLight')) }}" alt=""></td>
								</tr>
								<tr>
									<td colspan="3" height="20" class="large_only">
                                    <img src="{{ asset(\App\Setting::get('appLogoLight')) }}" alt=""></td>
					...
					<tr>
						<td class="w640" width="640" colspan="3" height="20">
                           <div class="text-center message_from">
                                Message sent from {{ config('app.name') }} app
                           </div>
                        </td>
					</tr>
					<tr>
