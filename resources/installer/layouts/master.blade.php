...
<html>
    <head>
        ...
        <title>@if (trim($__env->yieldContent('template_title')))@yield('template_title') | @endif Muzzie Installer</title>
        ...
        <div class="master">
            <div class="box">
                ...
                <ul class="step">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('LaravelInstaller::createAdmin')}}">
                        @if(Request::is('install/create-admin'))
                            <a href="{{ route('LaravelInstaller::createAdmin') }}">
